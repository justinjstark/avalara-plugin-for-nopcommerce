...
namespace Nop.Plugin.Tax.Avalara.Services
{
    public class AvalaraOrderProcessingService : OrderProcessingService
    {
        ...
        public AvalaraOrderProcessingService(IOrderService orderService,
            ...
            CurrencySettings currencySettings) : base(orderService,
                webHelper,
                localizationService,
                languageService,
                productService,
        ...
        protected decimal? GetTaxTotal(ProcessPaymentRequest processPaymentRequest, PlaceOrderContainter details)
        {
            ...
            foreach (var cartItem in details.Cart)
            {
                ...
                var scSubTotal = _priceCalculationService.GetSubTotal(cartItem, true, out discountAmount, out scDiscounts);
