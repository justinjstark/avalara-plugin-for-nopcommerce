...
namespace Nop.Plugin.Tax.Avalara.Data
{
    ...
    public class TaxTransactionLogObjectContext : DbContext, IDbContext
    {
        ...
        public TaxTransactionLogObjectContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }
        ...
        {
            //drop the table
            this.DropPluginTable(this.GetTableName<TaxTransactionLog>());
        }
